...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('payments', schema='fair_share_schema')
    op.drop_table('friendships', schema='fair_share_schema')
    op.drop_table('images', schema='fair_share_schema')
    op.drop_table('members', schema='fair_share_schema')
    op.drop_table('expenses', schema='fair_share_schema')
    op.drop_table('balances', schema='fair_share_schema')
    op.drop_table('groups', schema='fair_share_schema')
    op.drop_table('users', schema='fair_share_schema')
